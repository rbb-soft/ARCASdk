...
/**
 * La respuesta SOAP del padron A13 no es SoapFault pero no puede
 * normalizarse (body vacio/truncado, HTML de gateway, estructura SOAP
 * incompatible, campo obligatorio ausente de forma consistente).
 *
 ...
 */
class PadronProtocolException extends PadronException
{
    ...
    {
        return new self(
            'PADRON: respuesta SOAP vacia o truncada',
    ...
    {
        return new self(
            'PADRON: respuesta HTML de gateway/proxy (no es SOAP)',
