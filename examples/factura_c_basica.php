<?php
/**
 * Emisión de Factura C (cbte_tipo=11) con warmup y retry.
 *
 ...
 *
 * Uso:
 *   php examples/factura_c_basica.php                    [warmup 600s, 3 intentos, 60s entre]
 *   php examples/factura_c_basica.php 0                  [sin warmup, 3 intentos, 60s entre]
 *   php examples/factura_c_basica.php 0 1 0              [sin warmup, 1 intento]
 *
 * Comportamiento:
...
echo "=========================================\n";
echo " Emision Factura C (SDK con warmup+retry)\n";
echo "=========================================\n";
